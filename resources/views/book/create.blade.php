...
@section('heading_title')
    <!--begin::Heading-->
    <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">{{trans('book_create_edit.title')}}</h1>
    <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
        ...
        <li class="breadcrumb-item text-dark">{{trans('book_create_edit.title')}}</li>
    </ul>
    <!--end::Heading-->
@stop
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-placeholder="Select an option"
                                id="category_id">
                                <option value="-1">{{trans('book_create_edit.choose_category')}}</option>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <input type="number" name="price" min="0.1" step="0.1" class="form-control mb-2"
                                placeholder="{{trans('book_create_edit.price')}}" value="" id="price" />
                            <!--end::Input-->
                            <!--begin::Description-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="book_name" class="form-control mb-2"
                                                placeholder="{{trans('book_create_edit.book_name')}}" value="" id="name" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="author_name" class="form-control mb-2"
                                                placeholder="{{trans('book_create_edit.author_name')}}" value="" id="author_name" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
