            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    @if ($categories->isEmpty())
                        <tr>
                            <td valign="top" colspan="8" style="text-align: center">There is no Categories yet</td>
                        </tr>
                    @else
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="{{URL( 'category/' . $category->id) }}"
                                            ...
                                            <span class="symbol-label"
                                                style="background-image:url({{ Storage::url($category->image) }});"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5" style="padding: 15px 0;">
                                            ...
                                            <a href="{{URL( 'category/' . $category->id) }}"
                                                ...
                                                data-kt-ecommerce-category-filter="name">{{ $category->name }}</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    @if ($category->status == 1)
                                        <div class="badge badge-light-success" style="font-size:1.15rem">Active</div>
                                    @else
                                        <div class="badge badge-light-primary" style="font-size:1.15rem">Inactive</div>
                                    @endif
                                    <!--end::Badges-->
                                </td>
                                <!--end::Type=-->
                                ...
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('category.edit' ,  ['category'=>$category->id])}}" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                                <button class="btn menu-link px-3" onclick="DeleteCategory({{$category->id}},this)" style="font-size: .95rem; color:#7e8299; text-align: left; padding-left:0px">
                                                    Delete
                                                </button>
                                        </div>
                                        <!--end::Menu item-->
