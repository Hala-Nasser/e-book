...
@section('heading_title')
    <!--begin::Heading-->
    <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">{{trans('category_create_edit.edit_title')}}</h1>
    <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('home') }}" class="text-muted">{{trans('general.home')}}</a>
        </li>
        <li class="breadcrumb-item text-muted">{{trans('general.categories')}}</li>
        <li class="breadcrumb-item text-dark">{{trans('category_create_edit.edit_title')}}</li>
    </ul>
    <!--end::Heading-->
@stop
            ...
            <form id="kt_ecommerce_edit_category_form" class="form d-flex flex-column flex-lg-row"
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-title">
                                <h2>{{trans('category_create_edit.thumbnail')}}</h2>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--end::Card header-->
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                                style="background-image: url({{ Storage::url($category->image) }})" id="background">
                            ...
                            <!--end::Image input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">{{trans('category_create_edit.thumbnail_description')}}</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Card body-->
                    </div>
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                <h2>{{trans('category_create_edit.general')}}</h2>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                <label class="required form-label">{{trans('category_create_edit.category_name')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="category_name" class="form-control mb-2"
                                    placeholder="{{trans('category_create_edit.category_name')}}" value="{{$category->name}}" id="name" />
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">{{trans('category_create_edit.category_name_description')}}</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div>
                                <!--begin::Label-->
                                <label class="required form-label">{{trans('category_create_edit.status')}}</label>
                                <!--end::Label-->
                                <label class="switch" style="margin-left: 10px">
                                    <input type="checkbox" id="status" @checked($category->status )>
