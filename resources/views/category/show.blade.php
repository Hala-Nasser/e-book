...
@section('heading_title')
    <!--begin::Heading-->
    <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">{{$category->name}}</h1>
    <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
        ...
        <li class="breadcrumb-item text-dark">{{$category->name}}</li>
    </ul>
    <!--end::Heading-->
@stop
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="date_table">
                ...
                <thead>
                    ...
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-250px">{{trans('sub_category_index.sub_category')}}</th>
