...
@section('heading_title')
    <!--begin::Heading-->
    <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">{{trans('category_create_edit.create_title')}}</h1>
    <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
        ...
        <li class="breadcrumb-item text-dark">{{trans('category_create_edit.create_title')}}</li>
    </ul>
    <!--end::Heading-->
@stop
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="category_name" class="form-control mb-2"
                                    placeholder="{{trans('category_create_edit.category_name')}}" value="" id="name" />
                                <!--end::Input-->
                                <!--begin::Description-->
